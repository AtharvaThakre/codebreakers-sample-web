  ...
  return (
    <section className="experience">
      <div className="container d-flex">
        <img className="imgsignup" src="/assets/images/sign_up_screen.png" alt="sign_up_screen" />
        <div className="right-panel">
          <h2 className="text-36">The unseen of spending three years at Pixelgrade</h2>
          <p className="text-14 text-medium-gray">
